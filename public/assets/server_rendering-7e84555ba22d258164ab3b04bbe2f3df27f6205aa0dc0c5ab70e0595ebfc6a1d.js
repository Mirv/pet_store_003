...
var AllPets = function (props) {
  // output
  var pets = props.pets.map(function (pet) {
    return React.createElement(
      "div",
      { key: pet.id, "class": "col-lg-4 col-md-5 col-sm-6" },
      React.createElement(
        "li",
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "tbody",
            null,
            React.createElement(AllPets, { pets: this.state.pets })
          )
        )
      );
    }
